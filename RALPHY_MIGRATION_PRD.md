...
**Branch:** `claude/customizable-legend-uOYc2` (work here)
**Reference:** `main` branch (original UI - do not modify)
...
2. **Work on `claude/customizable-legend-uOYc2` branch only** - Never modify `main`
